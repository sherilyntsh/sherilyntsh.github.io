...
After playing around with the violin plot, we can see that the spreads for each variable is different across all breed groups. For 'mean_height', we can see that the 'Hound Group' breed has the widest height range, ranging from about 15cm to 79cm whereas 'Toy Group' has the smallest height range from about 17cm to 35cm. For 'mean_weight', we can see that the 'Working Group' breed has the widest weight range, ranging from 0kg to 80kg whereas 'Toy Group' has the smallest weight range from about 2kg to 8kg. For 'mean_expectancy', we can see that 'Working Group' has the widest expectancy range from about 6 years to 14 years whereas 'Toy Group' has the smallest expectancy range from about 13 years to 16 years. 